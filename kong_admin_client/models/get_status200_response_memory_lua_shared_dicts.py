...
class GetStatus200ResponseMemoryLuaSharedDicts(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of kong_core_db_cache
        if self.kong_core_db_cache:
            _dict['kong_core_db_cache'] = self.kong_core_db_cache.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "kong_core_db_cache": GetStatus200ResponseMemoryLuaSharedDictsKongCoreDbCache.from_dict(obj.get("kong_core_db_cache")) if obj.get("kong_core_db_cache") is not None else None
        })
        return _obj
