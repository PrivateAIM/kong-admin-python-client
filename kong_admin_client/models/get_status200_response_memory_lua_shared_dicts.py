...
class GetStatus200ResponseMemoryLuaSharedDicts(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kong_core_db_cache": GetStatus200ResponseMemoryLuaSharedDictsKongCoreDbCache.from_dict(obj["kong_core_db_cache"]) if obj.get("kong_core_db_cache") is not None else None
        })
        return _obj
