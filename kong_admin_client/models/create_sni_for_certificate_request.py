...
class CreateSniForCertificateRequest(BaseModel):
    """
    CreateSniForCertificateRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The SNI name to associate with the given certificate.")
    ...
    certificate: CreateSniForCertificateRequestCertificate
    __properties: ClassVar[List[str]] = ["name", "tags", "certificate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tags": obj.get("tags"),
            "certificate": CreateSniForCertificateRequestCertificate.from_dict(obj.get("certificate")) if obj.get("certificate") is not None else None
        })
        return _obj
