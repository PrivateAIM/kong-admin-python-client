...
class GetTimers200ResponseStats(BaseModel):
    ...
    """ # noqa: E501
    sys: Optional[GetTimers200ResponseStatsSys] = None
    flamegraph: Optional[GetTimers200ResponseStatsFlamegraph] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sys:
            _dict['sys'] = self.sys.to_dict()
        # override the default output from pydantic by calling `to_dict()` of flamegraph
        if self.flamegraph:
            _dict['flamegraph'] = self.flamegraph.to_dict()
