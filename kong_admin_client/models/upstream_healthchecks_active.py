...
class UpstreamHealthchecksActive(BaseModel):
    ...
    """ # noqa: E501
    concurrency: Optional[StrictInt] = 10
    headers: Optional[Dict[str, Any]] = None
    healthy: Optional[UpstreamHealthchecksActiveHealthy] = None
    http_path: Optional[StrictStr] = '/'
    https_sni: Optional[StrictStr] = None
    https_verify_certificate: Optional[StrictBool] = True
    timeout: Optional[Union[StrictFloat, StrictInt]] = 1
