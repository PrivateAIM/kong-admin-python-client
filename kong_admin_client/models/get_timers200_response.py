...
class GetTimers200Response(BaseModel):
    """
    GetTimers200Response
    """ # noqa: E501
    stats: Optional[GetTimers200ResponseStats] = None
    worker: Optional[GetTimers200ResponseWorker] = None
    __properties: ClassVar[List[str]] = ["stats", "worker"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "stats": GetTimers200ResponseStats.from_dict(obj.get("stats")) if obj.get("stats") is not None else None,
            "worker": GetTimers200ResponseWorker.from_dict(obj.get("worker")) if obj.get("worker") is not None else None
        })
        return _obj
