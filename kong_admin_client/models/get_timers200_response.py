...
class GetTimers200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": GetTimers200ResponseStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "worker": GetTimers200ResponseWorker.from_dict(obj["worker"]) if obj.get("worker") is not None else None
        })
        return _obj
