...
class GetTags200Response(BaseModel):
    ...
    GetTags200Response
    """ # noqa: E501
    data: Optional[List[GetTags200ResponseDataInner]] = None
    offset: Optional[StrictStr] = Field(default=None, description="Pagination information")
    next: Optional[StrictStr] = Field(default=None, description="Pagination information")
    __properties: ClassVar[List[str]] = ["data", "offset", "next"]
