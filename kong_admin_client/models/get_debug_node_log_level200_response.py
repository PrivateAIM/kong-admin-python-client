...
class GetDebugNodeLogLevel200Response(BaseModel):
    """
    GetDebugNodeLogLevel200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="A message containing the current log level of the node.")
