...
class ACL(BaseModel):
    ...
    """ # noqa: E501
    consumer: Optional[ACLConsumer] = None
    created_at: Optional[StrictInt] = Field(default=None, description="Unix epoch when the resource was created.")
    id: Optional[StrictStr] = None
    group: Optional[StrictStr] = Field(default=None, description="The group that this ACL represents.")
    ...
    __properties: ClassVar[List[str]] = ["consumer", "created_at", "id", "group", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumer": ACLConsumer.from_dict(obj["consumer"]) if obj.get("consumer") is not None else None,
