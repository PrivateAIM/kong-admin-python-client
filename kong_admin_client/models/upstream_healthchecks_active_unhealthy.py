...
class UpstreamHealthchecksActiveUnhealthy(BaseModel):
    """
    UpstreamHealthchecksActiveUnhealthy
    """ # noqa: E501
    http_failures: Optional[StrictInt] = 0
    http_statuses: Optional[List[StrictInt]] = None
    interval: Optional[Union[StrictFloat, StrictInt]] = 0
    tcp_failures: Optional[StrictInt] = 0
    timeouts: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["http_failures", "http_statuses", "interval", "tcp_failures", "timeouts"]
