...
class GetTimers200ResponseStatsTimers(BaseModel):
    """
    Timer statistics for the worker
    """ # noqa: E501
    meta: Optional[GetTimers200ResponseStatsTimersMeta] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "meta": GetTimers200ResponseStatsTimersMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj
