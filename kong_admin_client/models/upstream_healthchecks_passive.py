...
class UpstreamHealthchecksPassive(BaseModel):
    ...
    """ # noqa: E501
    healthy: Optional[UpstreamHealthchecksPassiveHealthy] = None
    type: Optional[StrictStr] = 'http'
    unhealthy: Optional[UpstreamHealthchecksPassiveUnhealthy] = None
    __properties: ClassVar[List[str]] = ["healthy", "type", "unhealthy"]
