...
class CreateVaultRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the Vault that's going to be added. Currently, the Vault implementation must be installed in every Kong instance. ")
    description: Optional[StrictStr] = Field(default=None, description="The description of the Vault object. ")
    config: Optional[CreateVaultRequestConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["prefix", "name", "description", "config", "tags"]
