...
class GetSniWithCertificate200ResponseDataInnerCertificate(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier or the name attribute of the Certificate whose SNIs")
