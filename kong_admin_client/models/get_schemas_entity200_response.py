...
class GetSchemasEntity200Response(BaseModel):
    """
    GetSchemasEntity200Response
    """ # noqa: E501
    fields: Optional[List[GetSchemasEntity200ResponseFieldsInner]] = Field(default=None, description="A value of a schema")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "fields": [GetSchemasEntity200ResponseFieldsInner.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None
        })
        return _obj
