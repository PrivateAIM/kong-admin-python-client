...
class CreateKeyAuthForConsumerRequest(BaseModel):
    """
    CreateKeyAuthForConsumerRequest
    """ # noqa: E501
    consumer: Optional[StrictStr] = Field(default=None, description="The id/username of the consumer that this Key will be associated with. ")
    key: Optional[StrictStr] = Field(default=None, description="The key to associate with the given consumer. If not specified, it will be auto-generated. ")
    ...
    __properties: ClassVar[List[str]] = ["consumer", "key", "tags"]
