...
class RoutesApi:
    ...
    def create_route(
        self,
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
        ...
        :param create_route_request: Route request body
    ...
    def create_route_for_service(
        ...
        _param = self._create_route_for_service_serialize(
    ...
    @validate_call
    def create_route_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_route_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
        _request_timeout: Union[
    ...
    def _create_route_for_service_serialize(
        self,
        service_id_or_name,
        create_route_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/services/{service_id_or_name}/routes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_route_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/routes/{route_id_or_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_route_for_service(
        ...
        _param = self._delete_route_for_service_serialize(
            service_id_or_name=service_id_or_name,
            route_id_or_name=route_id_or_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_route_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_route_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        _request_timeout: Union[
    ...
    def _delete_route_for_service_serialize(
        self,
        service_id_or_name,
        route_id_or_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/services/{service_id_or_name}/routes/{route_id_or_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_route_for_service(
        ...
        _param = self._fetch_route_for_service_serialize(
            service_id_or_name=service_id_or_name,
            route_id_or_name=route_id_or_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_route_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_route_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        _request_timeout: Union[
    ...
    def _fetch_route_for_service_serialize(
        self,
        service_id_or_name,
        route_id_or_name,
        _request_auth,
    ...
    def list_route(
        ...
        _param = self._list_route_serialize(
            size=size,
            offset=offset,
            tags=tags,
            _request_auth=_request_auth,
    ...
    def list_route_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListRoute200Response]:
        """List all routes
    ...
    @validate_call
    def list_route_without_preload_content(
        self,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
        tags: Annotated[Optional[StrictStr], Field(description="A list of tags to filter the list of resources on. Multiple tags can be concatenated using ','' to mean AND or using ''/'' to mean OR.'")] = None,
    ...
    def list_routes_for_service(
        ...
        _param = self._list_routes_for_service_serialize(
            service_id_or_name=service_id_or_name,
            size=size,
            offset=offset,
            tags=tags,
    ...
    @validate_call
    def list_routes_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
    ...
    @validate_call
    def list_routes_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
    ...
    def _list_routes_for_service_serialize(
        self,
        service_id_or_name,
        size,
        offset,
    ...
    def update_route_for_service(
        ...
        _param = self._update_route_for_service_serialize(
            service_id_or_name=service_id_or_name,
            route_id_or_name=route_id_or_name,
            create_route_request=create_route_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_route_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
    ...
    @validate_call
    def update_route_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
    ...
    def _update_route_for_service_serialize(
        self,
        service_id_or_name,
        route_id_or_name,
        create_route_request,
    ...
    def upsert_route(
        ...
        _param = self._upsert_route_serialize(
            route_id_or_name=route_id_or_name,
            create_route_request=create_route_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def upsert_route_with_http_info(
        self,
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def upsert_route_without_preload_content(
        self,
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
        _request_timeout: Union[
    ...
    def upsert_route_for_service(
        ...
        _param = self._upsert_route_for_service_serialize(
            service_id_or_name=service_id_or_name,
            route_id_or_name=route_id_or_name,
            create_route_request=create_route_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def upsert_route_for_service_with_http_info(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
    ...
    @validate_call
    def upsert_route_for_service_without_preload_content(
        self,
        service_id_or_name: Annotated[StrictStr, Field(description="ID **or** name of the service to lookup")],
        route_id_or_name: Annotated[StrictStr, Field(description="The unique identifier or the name of the route to retrieve.")],
        create_route_request: Annotated[Optional[CreateRouteRequest], Field(description="Route request body")] = None,
    ...
    def _upsert_route_for_service_serialize(
        self,
        service_id_or_name,
        route_id_or_name,
        create_route_request,
