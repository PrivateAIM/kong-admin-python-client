...
class KeyAuthsApi:
    ...
    @validate_call
    def create_key_auth_for_consumer(
        self,
        ...
        create_key_auth_for_consumer_request: Annotated[Optional[CreateKeyAuthForConsumerRequest], Field(description="key-auth request body")] = None,
        ...
        :param create_key_auth_for_consumer_request: key-auth request body
        :type create_key_auth_for_consumer_request: CreateKeyAuthForConsumerRequest
        ...
        _param = self._create_key_auth_for_consumer_serialize(
            consumer_username_or_id=consumer_username_or_id,
            create_key_auth_for_consumer_request=create_key_auth_for_consumer_request,
    ...
    @validate_call
    def create_key_auth_for_consumer_with_http_info(
        self,
        consumer_username_or_id: Annotated[StrictStr, Field(description="The unique identifier or the username of the Consumer to retrieve.")],
        create_key_auth_for_consumer_request: Annotated[Optional[CreateKeyAuthForConsumerRequest], Field(description="key-auth request body")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_key_auth_for_consumer_without_preload_content(
        self,
        consumer_username_or_id: Annotated[StrictStr, Field(description="The unique identifier or the username of the Consumer to retrieve.")],
        create_key_auth_for_consumer_request: Annotated[Optional[CreateKeyAuthForConsumerRequest], Field(description="key-auth request body")] = None,
        _request_timeout: Union[
    ...
    def _create_key_auth_for_consumer_serialize(
        self,
        consumer_username_or_id,
        create_key_auth_for_consumer_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_key_auth_for_consumer_request is not None:
            _body_params = create_key_auth_for_consumer_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/consumers/{consumer_username_or_id}/key-auth',
    ...
    @validate_call
    def list_key_auths_for_consumer(
        self,
        consumer_username_or_id: Annotated[StrictStr, Field(description="The unique identifier or the username of the Consumer to retrieve.")],
        ...
        _param = self._list_key_auths_for_consumer_serialize(
            consumer_username_or_id=consumer_username_or_id,
            size=size,
            offset=offset,
            tags=tags,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListKeyAuthsForConsumer200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_key_auths_for_consumer_with_http_info(
        self,
        consumer_username_or_id: Annotated[StrictStr, Field(description="The unique identifier or the username of the Consumer to retrieve.")],
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListKeyAuthsForConsumer200Response]:
        """List all Key-auths associated with a consumer
    ...
    @validate_call
    def list_key_auths_for_consumer_without_preload_content(
        self,
        consumer_username_or_id: Annotated[StrictStr, Field(description="The unique identifier or the username of the Consumer to retrieve.")],
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
    ...
    def _list_key_auths_for_consumer_serialize(
        self,
        consumer_username_or_id,
        size,
        offset,
