...
class CACertificatesApi:
    ...
    def create_ca_certificate(
        self,
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        ...
        :param create_ca_certificate_request: This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.
        :type create_ca_certificate_request: CreateCaCertificateRequest
        ...
        _param = self._create_ca_certificate_serialize(
            create_ca_certificate_request=create_ca_certificate_request,
    ...
    @validate_call
    def create_ca_certificate_with_http_info(
        self,
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_ca_certificate_without_preload_content(
        self,
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_ca_certificate_serialize(
        self,
        ...
        if create_ca_certificate_request is not None:
            _body_params = create_ca_certificate_request
    ...
    def delete_ca_certificate(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ca_certificate_id: ID of the related certificate (required)
        :type ca_certificate_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_ca_certificate_serialize(
    ...
    @validate_call
    def delete_ca_certificate_with_http_info(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_ca_certificate_without_preload_content(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        _request_timeout: Union[
            None,
    ...
    def _delete_ca_certificate_serialize(
        self,
        ca_certificate_id,
        _request_auth,
        _content_type,
        ...
        if ca_certificate_id is not None:
            _path_params['ca_certificate_id'] = ca_certificate_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/ca_certificates/{ca_certificate_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_ca_certificate(
        ...
        _param = self._list_ca_certificate_serialize(
            size=size,
            offset=offset,
            tags=tags,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_ca_certificate_with_http_info(
        self,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
        tags: Annotated[Optional[StrictStr], Field(description="A list of tags to filter the list of resources on. Multiple tags can be concatenated using ','' to mean AND or using ''/'' to mean OR.'")] = None,
    ...
    @validate_call
    def list_ca_certificate_without_preload_content(
        self,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Number of resources to be returned.")] = None,
        offset: Annotated[Optional[StrictStr], Field(description="Offset from which to return the next set of resources. Use the value of the 'offset' field from the response of a list operation as input here to paginate through all the resources")] = None,
        tags: Annotated[Optional[StrictStr], Field(description="A list of tags to filter the list of resources on. Multiple tags can be concatenated using ','' to mean AND or using ''/'' to mean OR.'")] = None,
    ...
    def _list_ca_certificate_serialize(
        self,
        size,
        offset,
        tags,
    ...
    def update_ca_certificate(
        ...
        _param = self._update_ca_certificate_serialize(
            ca_certificate_id=ca_certificate_id,
            create_ca_certificate_request=create_ca_certificate_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_ca_certificate_with_http_info(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_ca_certificate_without_preload_content(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
    ...
    def _update_ca_certificate_serialize(
        self,
        ca_certificate_id,
        create_ca_certificate_request,
        _request_auth,
    ...
    def updatet_ca_certificate(
        ...
        _param = self._updatet_ca_certificate_serialize(
            ca_certificate_id=ca_certificate_id,
            create_ca_certificate_request=create_ca_certificate_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def updatet_ca_certificate_with_http_info(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def updatet_ca_certificate_without_preload_content(
        self,
        ca_certificate_id: Annotated[StrictStr, Field(description="ID of the related certificate")],
        create_ca_certificate_request: Annotated[Optional[CreateCaCertificateRequest], Field(description="This request body represents a new Certificate Authority (CA) certificate and includes the properties required to create a new certificate.")] = None,
        _request_timeout: Union[
    ...
    def _updatet_ca_certificate_serialize(
        self,
        ca_certificate_id,
        create_ca_certificate_request,
        _request_auth,
