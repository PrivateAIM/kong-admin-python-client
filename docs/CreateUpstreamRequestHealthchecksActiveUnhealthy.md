...
create_upstream_request_healthchecks_active_unhealthy_from_dict = CreateUpstreamRequestHealthchecksActiveUnhealthy.from_dict(create_upstream_request_healthchecks_active_unhealthy_dict)
```
