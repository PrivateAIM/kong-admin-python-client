...
get_status200_response_memory_lua_shared_dicts_kong_core_db_cache_from_dict = GetStatus200ResponseMemoryLuaSharedDictsKongCoreDbCache.from_dict(get_status200_response_memory_lua_shared_dicts_kong_core_db_cache_dict)
```
