...
------------ | ------------- | ------------- | -------------
**id** | **str** | The unique id of the consumer. | [optional] 
**created_at** | **int** | Unix epoch when the resource was created.  | [optional] 
**username** | **str** | The unique username of the consumer. | [optional] 
**custom_id** | **str** | Field for the unique consumer ID | [optional] 
