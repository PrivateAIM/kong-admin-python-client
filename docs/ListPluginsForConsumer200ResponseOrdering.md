...
list_plugins_for_consumer200_response_ordering_from_dict = ListPluginsForConsumer200ResponseOrdering.from_dict(list_plugins_for_consumer200_response_ordering_dict)
```
