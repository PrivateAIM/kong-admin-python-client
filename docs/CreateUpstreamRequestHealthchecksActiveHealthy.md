...
create_upstream_request_healthchecks_active_healthy_from_dict = CreateUpstreamRequestHealthchecksActiveHealthy.from_dict(create_upstream_request_healthchecks_active_healthy_dict)
```
