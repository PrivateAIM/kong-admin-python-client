...
create_target_for_upstream_request_upstream_from_dict = CreateTargetForUpstreamRequestUpstream.from_dict(create_target_for_upstream_request_upstream_dict)
```
