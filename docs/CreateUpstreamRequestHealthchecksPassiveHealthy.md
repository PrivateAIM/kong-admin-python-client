...
create_upstream_request_healthchecks_passive_healthy_from_dict = CreateUpstreamRequestHealthchecksPassiveHealthy.from_dict(create_upstream_request_healthchecks_passive_healthy_dict)
```
