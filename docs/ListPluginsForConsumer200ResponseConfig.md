...
list_plugins_for_consumer200_response_config_from_dict = ListPluginsForConsumer200ResponseConfig.from_dict(list_plugins_for_consumer200_response_config_dict)
```
