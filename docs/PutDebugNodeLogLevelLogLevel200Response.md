...
put_debug_node_log_level_log_level200_response_from_dict = PutDebugNodeLogLevelLogLevel200Response.from_dict(put_debug_node_log_level_log_level200_response_dict)
```
