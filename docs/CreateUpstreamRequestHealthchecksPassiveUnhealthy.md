...
create_upstream_request_healthchecks_passive_unhealthy_from_dict = CreateUpstreamRequestHealthchecksPassiveUnhealthy.from_dict(create_upstream_request_healthchecks_passive_unhealthy_dict)
```
