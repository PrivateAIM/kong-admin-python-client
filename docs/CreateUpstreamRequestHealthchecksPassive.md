...
create_upstream_request_healthchecks_passive_from_dict = CreateUpstreamRequestHealthchecksPassive.from_dict(create_upstream_request_healthchecks_passive_dict)
```
