...
create_upstream_request_healthchecks_active_from_dict = CreateUpstreamRequestHealthchecksActive.from_dict(create_upstream_request_healthchecks_active_dict)
```
