...
get_schemas_entity200_response_fields_inner_from_dict = GetSchemasEntity200ResponseFieldsInner.from_dict(get_schemas_entity200_response_fields_inner_dict)
```
